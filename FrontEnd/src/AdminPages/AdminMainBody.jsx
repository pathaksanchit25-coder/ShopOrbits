      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10">
        {actions.map((action) => (
          <Link
            key={action.name}
            to={action.link}
            className={`flex flex-col items-center justify-center p-8 rounded-2xl bg-gradient-to-r ${action.gradient} text-black shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all`}
          >
